...
public class RegisterService {
    ...
    public RegisterService(ApplicationUserService appUserService, EmailValidator emailValidator, ConfirmationTokenService confirmationTokenService, EmailSender emailSender) {
    ...
    public String register(RegisterRequest request) {
        ...
        if (appUserService.findUserByEmail(request.getEmail()).isPresent()) {
            throw new IllegalStateException("email already present in the database");
        }
